-- Database generated with pgModeler (testQL Database Modeler).
...
CREATE SCHEMA IF NOT EXISTS plan_cuentas;
-- ddl-end --
ALTER SCHEMA plan_cuentas OWNER TO test;
-- ddl-end --

COMMENT ON SCHEMA plan_cuentas IS 'esquema para gestion de rubros, apropiaciones, fuentes de financiamiento';
-- ddl-end --
...
-- ddl-end --
ALTER TABLE plan_cuentas.apropiacion OWNER TO test;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE plan_cuentas.estado_apropiacion OWNER TO test;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE plan_cuentas.rubro OWNER TO test;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE plan_cuentas.rama OWNER TO test;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE plan_cuentas.fuente_financiamiento OWNER TO test;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE plan_cuentas.tipo_fuente_financiamiento OWNER TO test;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE plan_cuentas.fuente_financiamiento_apropiacion OWNER TO test;
-- ddl-end --
