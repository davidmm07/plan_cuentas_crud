...
// @Param	body		body 	models.TipoFuenteFinanciamiento	true		"body for TipoFuenteFinanciamiento content"
// @Success 201 {int} models.TipoFuenteFinanciamiento
// @Failure 403 body is empty
// @router / [post]
func (c *TipoFuenteFinanciamientoController) Post() {
	var v models.TipoFuenteFinanciamiento
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddTipoFuenteFinanciamiento(&v); err == nil {
...
// @Success 200 {object} models.TipoFuenteFinanciamiento
// @Failure 403 :id is empty
// @router /:id [get]
func (c *TipoFuenteFinanciamientoController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetTipoFuenteFinanciamientoById(id)
	if err != nil {
		c.Data["json"] = err.Error()
		panic(err.Error())
	} else {
...
func (c *TipoFuenteFinanciamientoController) GetAll() {
	...
	l, err := models.GetAllTipoFuenteFinanciamiento(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
		panic(err.Error())
	} else {
...
func (c *TipoFuenteFinanciamientoController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.TipoFuenteFinanciamiento{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateTipoFuenteFinanciamientoById(&v); err == nil {
			c.Data["json"] = "OK"
		} else {
			c.Data["json"] = err.Error()
			panic(err.Error())
...
func (c *TipoFuenteFinanciamientoController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteTipoFuenteFinanciamiento(id); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
		panic(err.Error())
